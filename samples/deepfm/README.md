...
```json.
{
    ...
    "models":[
        {
            "model":"dcn",
            "sparse_files":["/model/deepfm/1/0_sparse_file.model"],
            "dense_file":"/model/deepfm/1/_dense_file.model",
            "network_file":"/model/deepfm/1/deepfm.json"
        }
    ]  
}
...
```shell.
 root@2efa5b50b909: tritonserver --model-repository=/model/ --model-control-mode=explicit \ 
 --load-model=dcn --load-model=deepfm \
